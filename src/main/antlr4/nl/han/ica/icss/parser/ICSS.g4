...
//Stylerule
styleRule: (tagSelector | classSelector | idSelector) OPEN_BRACE (declaration | ifClause | variableAssignment)* CLOSE_BRACE;
...
//If Else
ifClause: IF BOX_BRACKET_OPEN (variableReference | boolLiteral) BOX_BRACKET_CLOSE OPEN_BRACE
